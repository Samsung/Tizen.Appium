...
namespace Xamarin.Issues.UITests
{
    ...
    public class DatePickerTest_MinimumDate_UIBH
    {
        string PlatformName;
        AppiumDriver Driver;

        public DatePickerTest_MinimumDate_UIBH(string platform)
        {
        ...
        public void DatePickerTest()
        {
            ...
            string expect = "3/10/16 12:00:00 AM";
            string ret = WebElementUtils.GetAttribute(Driver, "DatePicker", "MinimumDate");
