...
namespace Xamarin.Issues.UITests
{
    ...
    public class DatePickerTest_DatePicker_UIBH
    {
        string PlatformName;
        AppiumDriver Driver;

        public DatePickerTest_DatePicker_UIBH(string platform)
        {
        ...
        public void DatePickerTest()
        {
            ...
            string expect = "7/26/16 12:00:00 AM";
            string ret = WebElementUtils.GetAttribute(Driver, "DatePicker", "Date");
